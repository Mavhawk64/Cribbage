 ...
 */
public class Deck {
    private final Card[] FULL_DECK = { new Card("Club", "Ace", 1), new Card("Club", "2", 2), new Card("Club", "3", 3),
            new Card("Club", "4", 4), new Card("Club", "5", 5), new Card("Club", "6", 6), new Card("Club", "7", 7),
            new Card("Club", "8", 8), new Card("Club", "9", 9), new Card("Club", "10", 10),
            new Card("Club", "Jack", 10), new Card("Club", "Queen", 10), new Card("Club", "King", 10),
            new Card("Diamond", "Ace", 1), new Card("Diamond", "2", 2), new Card("Diamond", "3", 3),
            new Card("Diamond", "4", 4), new Card("Diamond", "5", 5), new Card("Diamond", "6", 6),
            new Card("Diamond", "7", 7), new Card("Diamond", "8", 8), new Card("Diamond", "9", 9),
            new Card("Diamond", "10", 10), new Card("Diamond", "Jack", 10), new Card("Diamond", "Queen", 10),
            new Card("Diamond", "King", 10), new Card("Spade", "Ace", 1), new Card("Spade", "2", 2),
            new Card("Spade", "3", 3), new Card("Spade", "4", 4), new Card("Spade", "5", 5), new Card("Spade", "6", 6),
            new Card("Spade", "7", 7), new Card("Spade", "8", 8), new Card("Spade", "9", 9),
            new Card("Spade", "10", 10), new Card("Spade", "Jack", 10), new Card("Spade", "Queen", 10),
            new Card("Spade", "King", 10), new Card("Heart", "Ace", 1), new Card("Heart", "2", 2),
            new Card("Heart", "3", 3), new Card("Heart", "4", 4), new Card("Heart", "5", 5), new Card("Heart", "6", 6),
            new Card("Heart", "7", 7), new Card("Heart", "8", 8), new Card("Heart", "9", 9),
            new Card("Heart", "10", 10), new Card("Heart", "Jack", 10), new Card("Heart", "Queen", 10),
    ...
    public void discardPlayerCards(int playerid) {
        ...
        for (int i = 0; i < discard.length; i++) {
            ...
            while (input < 1 || input > this.hands[playerid].size() || discard[0] == input
                    || discard[discard.length - 1] == input) {
                System.out.println(
                        "Invalid input. Enter the card you want to discard (1-" + this.hands[playerid].size() + "): ");
                input = sc.nextInt();
            }
            discard[i] = input;
        }
